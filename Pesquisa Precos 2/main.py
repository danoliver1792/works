...
def search():
    try:
        ...
        file_xlsx = r'C:\Users\danrl\OneDrive\Python\Buscador de Precos\price.xlsx'
        sheet_xlsx = 'Plan1'
        column = 'A'
        ...
        driver = webdriver.Chrome(service=ChromeService(ChromeDriverManager('117.0.5938.132').install()))
        ...
        for i, row_cell in enumerate(sheet[column], start=1):
            ...
            xpath_search_olx = '//*[@id="oraculo-4-input"]'
            xpath_search_olx_click = '//*[@id="header"]/nav/div/div[1]/div[2]/form/button'
            ...
            try:
                ...
                print(f"XPATH nao encontrado para o valor {value_cell}")
        ...
        for i, row_cell in enumerate(sheet[column], start=1):
            ...
            xpath_product_ml = '//*[@id="react-aria-:R1l9b9:"]/div[2]/div[1]'
            xpath_price_ml = '//*[@id="react-aria-:R1l9b9:"]/div[2]/div[2]/div[1]/div[1]/div/div/div'
        ...
        for i, row_cell in enumerate(sheet[column], start=1):
            ...
            xpath_price_smart = '//*[@id="gallery-layout-container"]/div[1]/section/a/article/div[6]/div'
...
# loading image
image = Image.open(r'C:\Users\danrl\OneDrive\Python\Buscador de Precos\logo.jpg')
