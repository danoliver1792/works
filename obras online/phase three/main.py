...
# CSV file creation
csv_file = r'C:\Users\danrl\OneDrive\Python\Obras Online\Results\obras_online.csv'
...
with open(csv_file, 'w', newline='', encoding='utf-8') as file:
    ...
    while i < 77:
        for n in range(1, 51):
            ...
            xpath_status = (f'/html/body/form/div[7]/div[2]/div/div/div/div/div/div[4]/div/div[{n}]/div/div['
                            f'1]/div/div[9]/span[2]')
            xpath_fase = (f'/html/body/form/div[7]/div[2]/div/div/div/div/div/div[4]/div/div[{n}]/div/div[1]/div/div['
                          f'10]/span[2]')
            ...
            status = driver.find_element(By.XPATH, xpath_status).text
            fase = driver.find_element(By.XPATH, xpath_fase).text

            writer.writerow([empresa, entidade, nome_obra, empreendedor, contato, cargo, telefones, email, endereco,
                             numero, cidade, uf, previsao, sub, especificacao, investimento, valor, status, fase])
