...
# using the filters
# "Sub-Setor"
xpath_sub_educacao = ('//*[@id="ctl00_ContentPlaceHolderPrincipal_filtroDeObras_containerPesquisaDeObras"]/div['
                      '2]/div/div/fieldset/div/div[2]/div[1]/div/div')
driver.find_element(By.XPATH, xpath_sub_educacao).click()
sleep(2)
...
while i < 100:
    ...
    xpath_page = '/html/body/form/div[7]/div[2]/div/div/div/div/div/div[5]/div/div/ul/li[5]/a'
